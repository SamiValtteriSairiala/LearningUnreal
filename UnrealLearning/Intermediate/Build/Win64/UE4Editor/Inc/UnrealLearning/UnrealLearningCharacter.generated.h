...
#ifdef UNREALLEARNING_UnrealLearningCharacter_generated_h
#error "UnrealLearningCharacter.generated.h already included, missing '#pragma once' in UnrealLearningCharacter.h"
#endif
...
public: \
	DECLARE_CLASS(AUnrealLearningCharacter, ACharacter, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/UnrealLearning"), NO_API) \
...
#define UnrealLearning_Source_UnrealLearning_UnrealLearningCharacter_h_15_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AUnrealLearningCharacter); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AUnrealLearningCharacter); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API AUnrealLearningCharacter(AUnrealLearningCharacter&&); \
	NO_API AUnrealLearningCharacter(const AUnrealLearningCharacter&); \
public:
...
#define UnrealLearning_Source_UnrealLearning_UnrealLearningCharacter_h_15_PRIVATE_PROPERTY_OFFSET \
	...
	FORCEINLINE static uint32 __PPO__VR_Gun() { return STRUCT_OFFSET(AUnrealLearningCharacter, VR_Gun); } \
	FORCEINLINE static uint32 __PPO__VR_MuzzleLocation() { return STRUCT_OFFSET(AUnrealLearningCharacter, VR_MuzzleLocation); } \
	FORCEINLINE static uint32 __PPO__FirstPersonCameraComponent() { return STRUCT_OFFSET(AUnrealLearningCharacter, FirstPersonCameraComponent); } \
	FORCEINLINE static uint32 __PPO__R_MotionController() { return STRUCT_OFFSET(AUnrealLearningCharacter, R_MotionController); } \
...
#define CURRENT_FILE_ID UnrealLearning_Source_UnrealLearning_UnrealLearningCharacter_h
